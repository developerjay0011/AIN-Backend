export const initialSettings = [
    ...
    { key_name: 'GOOGLE_MAPS_EMBED_URL', value: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3582.835438338517!2d91.79357087581805!3d26.104289994363594!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x375a5f2109f4a7b7%3A0xcf8037a4cb6df55d!2sArmy%20Institute%20of%20Nursing!5e0!3m2!1sen!2sin!4v1774261815749!5m2!1sen!2sin', label: 'Google Maps Embed URL', group_name: 'Map' },
    {
        ...
        value: JSON.stringify([
            { initials: 'INC', name: 'Indian Nursing Council, New Delhi', url: 'https://www.indiannursingcouncil.org', logo: '/uploads/images/settings/inc-logo.png' },
            { initials: 'ANMHVC', name: "Assam Nurses' Midwives' & Health Visitors' Council, Guwahati", url: 'https://www.assamnursingcouncil.com/', logo: '/uploads/images/settings/anmhvc-logo.png' },
            { initials: 'SSUHS', name: 'Srimanta Sankaradeva University of Health Sciences, Assam', url: 'https://ssuhs.ac.in/', logo: '/uploads/images/settings/ssuhs-logo.png' },
            { initials: 'TNAI', name: 'Trained Nurses Association of India', url: 'https://www.tnaionline.org', logo: '/uploads/images/settings/tnai-logo.png' },
            { initials: 'AWES', name: 'Army Welfare Education Society', url: 'https://www.awesindia.com/', logo: '/uploads/images/settings/awes-logo.png' }
        ]),
    ...
    { key_name: 'PGWAT_REGISTRATION_LINK', value: 'https://ainguwahati.cbtexam.in/Home/home.aspx', label: 'PGWAT Registration Link', group_name: 'Admissions' },
    { key_name: 'PGWAT_REGISTRATION_VISIBLE', value: 'true', label: 'Show PGWAT Registration Button', group_name: 'Admissions' },
