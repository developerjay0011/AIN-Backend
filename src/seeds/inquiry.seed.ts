...
export const seedInquiries = async () => {
    const admissionInquiries = [
        ...
        ['ADM-1003', 'Sneha Baruah', 'Nitul Baruah', 'sneha.b@example.com', '7654321098', 'M.Sc Nursing', 'Does the institute provide hostel facilities for M.Sc students?', 'Closed'],
    ...
    const contactInquiries = [
        ...
        ['CON-2003', 'Dr. S. Roy', 's.roy@hospital.com', '7766554433', 'Job Placement', 'We have vacancies for staff nurses. How can we conduct campus interviews?', 'Resolved']
    ];
